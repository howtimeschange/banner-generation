...
Create a prompt file and call:

```bash
node /Users/xingyicheng/.codex/skills/banner-generation/scripts/generate_1xm_image.mjs \
...
```bash
node /Users/xingyicheng/.codex/skills/banner-generation/scripts/render_html_banner.mjs \
